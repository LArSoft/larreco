#ifndef RECOTOOL_PI0SHOWERRECOALG_CXX
#define RECOTOOL_PI0SHOWERRECOALG_CXX
...
namespace showerreco {
  ...
  ::recob::Shower Pi0ShowerRecoAlg::RecoOneShower(const std::vector< ::showerreco::ShowerCluster_t>& clusters)
  {
