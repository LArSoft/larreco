...
//
//
// ClusterTrajectoryAlg
//
// Bruce Baller
//
///////////////////////////////////////////////////////////////////////
#ifndef CLUSTERTRAJECTORYALG_H
#define CLUSTERTRAJECTORYALG_H
...
namespace cluster {
  ...
  class ClusterTrajAlg {
    ...
    ClusterTrajAlg(fhicl::ParameterSet const& pset);

    virtual void reconfigure(fhicl::ParameterSet const& pset);
    void RunClusterTrajectoryAlg(std::vector<art::Ptr<recob::Hit>> const& allhits);
...
#endif // ifndef CLUSTERTRAJECTORYALG_H
