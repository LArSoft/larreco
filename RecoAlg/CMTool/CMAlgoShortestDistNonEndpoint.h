 ...
 * 
 * \brief Class def header for a class CMAlgoShortestDistNonEndpoint
 *
 * @author davidkaleko
 */
...
/** \addtogroup ClusterCluster
    ...
    @{*/
#ifndef CMALGOSHORTESTDISTNONENDPOINT_H
#define CMALGOSHORTESTDISTNONENDPOINT_H
...
namespace cluster {
  /**
     \class CMAlgoShortestDistNonEndpoint
     User defined class CMAlgoShortestDistNonEndpoint ... these comments are used to generate
     doxygen documentation!
  */
  class CMAlgoShortestDistNonEndpoint : public CBoolAlgoBase{
    
  public:
    
    /// Default constructor
    CMAlgoShortestDistNonEndpoint();
    
    /// Default destructor
    virtual ~CMAlgoShortestDistNonEndpoint(){};
