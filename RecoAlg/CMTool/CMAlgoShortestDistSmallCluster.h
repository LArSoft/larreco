/**
 * \file CMAlgoShortestDistSmallCluster.hh
 *
 * \ingroup ClusterRecoUtil
 * 
 * \brief Class def header for a class CMAlgoShortestDistSmallCluster
 *
 * @author davidkaleko
 */
...
/** \addtogroup ClusterRecoUtil
    ...
    @{*/
#ifndef CMALGOSHORTESTDISTSMALLCLUSTER_HH
#define CMALGOSHORTESTDISTSMALLCLUSTER_HH
...
namespace cluster {
  ...
  */
  class CMAlgoShortestDistSmallCluster : public CBoolAlgoBase{
    
  public:
    
    /// Default constructor
    CMAlgoShortestDistSmallCluster();
    
    /// Default destructor
    virtual ~CMAlgoShortestDistSmallCluster(){};
