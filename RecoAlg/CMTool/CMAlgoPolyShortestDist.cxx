...
#include "CMAlgoPolyShortestDist.h"
...
namespace cluster {
  ...
  //------------------------------------------------------------------------------------------
  void CMAlgoPolyShortestDist::EventBegin(const std::vector<cluster::ClusterParamsAlg> &clusters)
  //------------------------------------------------------------------------------------------
  {
    if(clusters.size())
      tmp_min_dist = 99999;
  ...
  //-----------------------------------------------------------------------------------------------
  //void CMAlgoPolyShortestDist::IterationBegin(const std::vector<cluster::ClusterParamsAlg> &clusters)
  //-----------------------------------------------------------------------------------------------
  //{
  //
  //}
  ...
  //----------------------------------------------------------------
  bool CMAlgoPolyShortestDist::Bool(const ClusterParamsAlg &cluster1,
