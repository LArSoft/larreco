...
namespace trkf {
  ...
  public:
    ...
    struct RecoHists
    {
      ...
      TH1F* fHmom;         // Momentum.
      TH1F* fHlen;         // Length.
      TH1F* fHNMeas;       // Number of measurements.
      TH1F* fHChisq;       // Chisquare.
      TH1F* fHChisqDOF;    // Chisquare per degree-of-freedom.
  ...
  //
  {
    ...
    *this = RecoHists();
    ...
    fHNMeas = dir.make<TH1F>("nmeas", "Number of Measurements", 100, 0., 10000.);
    fHChisq = dir.make<TH1F>("chisq", "Chisquare", 100, 0., 10000.);
    fHChisqDOF = dir.make<TH1F>("chisqdof", "Chisquare/DOF", 100, 0., 10.);
  ...
  //
  {
	...
	if(ntraj > 0) {
	  ...
	  rhists.fHNMeas->Fill(track.NMeas());
	  rhists.fHChisq->Fill(track.Chisq());
	  rhists.fHChisqDOF->Fill(track.ChisqDOF());
