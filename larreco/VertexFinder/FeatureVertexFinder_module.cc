...
namespace vertex {
  ...
  private:
    ...
    void Find2dClusterVertexCandidates(art::PtrVector<recob::Cluster> RawClusters,
    ...
    void Find3dVtxFrom2dClusterVtxCand(std::vector<double> Wire_2dvtx,
                                       std::vector<double> Time_2dvtx,
                                       std::vector<double> Plane_2dvtx);
...
namespace vertex {
  ...
  // -----------------------------------------------------------------------------
  void
  vertex::FeatureVertexFinder::Find3dVtxFrom2dClusterVtxCand(std::vector<double> Wire_2dvtx,
                                                             std::vector<double> Time_2dvtx,
                                                             std::vector<double> Plane_2dvtx)
  {
              ...
              if (match) {
                ...
                if (std::abs(tempXCluster1 - tempXCluster2) < 0.5 && candidate_x.size() < 101) {
                  ...
                  candidate_strength.push_back(
                    10); //<--For cluster verticies I give it a strength of "10" arbitrarily for now
