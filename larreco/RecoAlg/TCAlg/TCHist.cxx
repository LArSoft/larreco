...
namespace  tca {
  ...
  void HistStuff::CreateHists(art::TFileService& tfs)
  {
    ...
    fProtonLike[0] = tfs.make<TH1F>("ProtonLike_elec","ProtonLike_elec", 24, 6, 14);
    fProtonLike[1] = tfs.make<TH1F>("ProtonLike_muon","ProtonLike_muon", 24, 6, 14);
    fProtonLike[2] = tfs.make<TH1F>("ProtonLike_pion","ProtonLike_pion", 24, 6, 14);
    fProtonLike[3] = tfs.make<TH1F>("ProtonLike_kaon","ProtonLike_kaon", 24, 6, 14);
    fProtonLike[4] = tfs.make<TH1F>("ProtonLike_prot","ProtonLike_prot", 24, 6, 14);
