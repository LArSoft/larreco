...
namespace cmtool {
  ...
  //-------------------------------------------------------
  {
    ...
    if (!_fout_hax) _fout_hax = new TFile("fout_hax.root", "RECREATE");
    ...
    if (!_ana_tree) {
      ...
      _ana_tree->Branch(
        "max_poly_perim_over_A", &_max_poly_perim_over_A, "max_poly_perim_over_A/D");
  ...
  //----------------------------------------------------------------------------------------------
  {
    ...
    for (auto const& c : clusters) {
      ...
      double this_poly_perim_over_A =
        c->GetParams().PolyObject.Perimeter() / c->GetParams().PolyObject.Area();
      if (this_poly_perim_over_A > _max_poly_perim_over_A)
        _max_poly_perim_over_A = this_poly_perim_over_A;
