...
void
cluster::SmallClusterFinderAlg::reconfigure(fhicl::ParameterSet const& pset)
{
...
void
cluster::SmallClusterFinderAlg::FindSmallClusters(std::vector<art::Ptr<recob::Hit>> allHits)
{
...
*/
void
cluster::SmallClusterFinderAlg::SelectLocalHitlist(std::vector<art::Ptr<recob::Hit>> hitlist,
