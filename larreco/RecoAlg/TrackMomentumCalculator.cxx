...
namespace {
  ...
  constexpr auto range_gramper_cm_proton()
  {
    std::array<double, 60> Range_grampercm_proton{
      {0.05724,   0.06726,   0.07798,   0.08937,   0.1014,    0.1142,    0.1276,    0.1416,    0.1563,    0.1716,
       0.1875,    0.2764,    0.3801,    0.4981,    0.6301,    0.9342,    1.106,     1.290,     1.695,     2.149,
       2.649,     3.193,     3.782,     4.413,     5.086,     5.799,     6.552,     7.344,     8.173,     9.040,
       9.942,    10.880,    16.080,    22.070,    28.770,    36.140,    44.110,    52.640,    61.680,    71.200,
       91.540,   113.400,   136.600,   161.000,   186.300,   212.600,   239.600,   267.400,   295.700,   324.600,
       353.900,  383.700,   413.800,   444.300,   761.100,  1088.000,  1416.000,  1743.000,  2388.000,  3018.000,}};
  ...
  constexpr std::array<double, 60> KE_MeV_proton{ // from PSTAR: https://physics.nist.gov/PhysRefData/Star/Text/PSTAR.html, using "Projected" column to consider the "Detour Factor"
    {5.0,     5.5,     6.0,     6.5,     7.0,     7.5,     8.0,     8.5,     9.0,     9.5,
     10.0,    12.5,    15.0,    17.5,    20.0,    25.0,    27.5,    30.0,    35.0,    40.0,
     45.0,    50.0,    55.0,    60.0,    65.0,    70.0,    75.0,    80.0,    85.0,    90.0,
     95.0,   100.0,   125.0,   150.0,   175.0,   200.0,   225.0,   250.0,   275.0,   300.0,
     350.0,   400.0,   450.0,   500.0,   550.0,   600.0,   650.0,   700.0,   750.0,   800.0,
     850.0,   900.0,   950.0,  1000.0,  1500.0,  2000.0,  2500.0,  3000.0,  4000.0,  5000.0};}
